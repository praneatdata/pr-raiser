"""
PR Raiser — a Slack bot that opens a GitHub PR whenever someone posts a
github.com/.../compare/... link in a channel the bot is in, or in a DM to it.

Runs over Slack Socket Mode, so it needs no public URL.
"""
import os
import re
import logging
